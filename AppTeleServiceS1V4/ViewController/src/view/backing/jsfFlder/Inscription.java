...
public class Inscription {
    ...
    public String suivant1_action() throws IOException {
        FacesContext context = FacesContext.getCurrentInstance();
        context.getExternalContext().redirect("/AppTeleServiceS1V4-ViewController-context-root/faces/jsfFlder/InscriptionContribuable.jsf");
        return null;
    }
}
