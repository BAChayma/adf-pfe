...
public class Declaration {
    ...
    private RichInputListOfValues kimpotId;
    ...
    public void setKimpotId(RichInputListOfValues kimpotId) {
        this.kimpotId = kimpotId;
    }

    public RichInputListOfValues getKimpotId() {
        return kimpotId;
    }
    ...
    public void calculer_action() {
        
         FacesContext facesContext = FacesContext.getCurrentInstance();
         UIViewRoot root = facesContext.getViewRoot();
         
         String montantdcl = this.getIt5().getValue().toString();
         String tauxdcl = this.getIt9().getValue().toString();
         
         System.out.println("montant :" + montantdcl);
         System.out.println("taux :" + tauxdcl);
        
        float MontantD = (Float.valueOf(montantdcl)).floatValue(); 
        float TauxImpot = (Float.valueOf(tauxdcl)).floatValue();
        System.out.println("MontantDu * TauxImpot / 100 = " +(((MontantD * TauxImpot) / 100)) + MontantD );
        float montantPayer = ((((MontantD * TauxImpot) / 100) + MontantD)) ;
        String mp1 = String.valueOf(montantPayer);
        it5.setValue(montantdcl);
        it6.setValue(mp1);
    ...
    public String enregistrer_action() {
